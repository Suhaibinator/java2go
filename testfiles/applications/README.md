...
| `raw_inner_unbound_reference_gap` | Raw unbound generic inner method reference, one reference across multiple concrete instantiations, distinct outer/inner erasures, heap pollution, and delayed casts | Known gap (`go_compile`) |
